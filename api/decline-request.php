...
try {
    ...
    // Create request decline record
    $stmt = $conn->prepare("
        INSERT INTO request_declines (
    ...
    sendResponse(true, null, 'Request declined successfully');
    ...
    sendResponse(false, null, 'Failed to decline request: ' . $e->getMessage());
}
?> 